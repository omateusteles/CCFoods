...
namespace Modulo1.ViewModel
{
    ...
    public class ClienteViewModel : INotifyPropertyChanged
    {
        ...
        //Observe que nos métodos  set()  é chamado OnPropertyChanged() , que atualiza a propriedade que sofreu alteração.
        public string Nome
        {
            get { return _nome; }
        ...
        public ICommand Gravar
        {
            get
            {
                ...
                return new Command(() =>
                {
                    ...
                    //Com a obtenção do objeto, ele é então submetido ao DAL para persistência.
                    App.Current.MainPage.DisplayAlert("Inserção Cliente", "Cliente inserido com sucesso", "OK");
                });
            }
        }

        //cria e retorna um objeto de nosso modelo, Cliente
