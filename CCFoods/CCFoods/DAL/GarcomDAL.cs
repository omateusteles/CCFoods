...
namespace Modulo1.Dal
{
    public class GarcomDAL
    {
        ...
        public IEnumerable<Garcom> GetAllInseridoDispositivo()
        {
            ...
            return (from t in sqlConnection.Table<Garcom>()
                    where t.OperacaoSincronismo == Modelo.Enums.OperacaoSincronismo.InseridoDispositivo && t.DispositivoId == configuracaoId
